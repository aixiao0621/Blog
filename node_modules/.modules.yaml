...
hoistedDependencies:
  ...
  /@rollup/plugin-commonjs/23.0.2_rollup@3.7.5:
    '@rollup/plugin-commonjs': private
  /@rollup/plugin-json/5.0.1_rollup@3.7.5:
  ...
  /@sveltejs/vite-plugin-svelte/1.2.0_svelte@3.51.0+vite@3.2.4:
  ...
  /@unocss/preset-tagify/0.46.5:
    '@unocss/preset-tagify': private
  /@unocss/preset-typography/0.46.5:
  ...
  /@unocss/transformer-attributify-jsx/0.46.5:
  ...
  /svelte-hmr/0.15.1_svelte@3.51.0:
    svelte-hmr: private
  /svgo/2.8.0:
    svgo: private
  /temp-dir/2.0.0:
...
pendingBuilds: []
prunedAt: Sun, 18 Dec 2022 12:58:02 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /esbuild-windows-arm64/0.15.14
  - /fsevents/2.3.2
storeDir: /home/trle5/.local/share/pnpm/store/v3
